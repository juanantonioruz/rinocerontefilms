...
<link rel="stylesheet" href="http://rinocerontefilms.com/wp-content/themes/default/editor-style.css" type="text/css" media="screen, projection">
...
function preparaContenido($content){
	$ejemplo = apply_filters('the_content', $content);
